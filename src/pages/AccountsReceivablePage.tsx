...
const AccountsReceivablePage = () => {
  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-white">
      ...
      {/* ========== TESTIMONIALS ========== */}
      <div className="ar-testimonials-grid">
        <div className="ar-testimonial">
          <ServiceTestimonials
            title="Proven Results for Practices"
            subtitle="Real revenue recovery and A/R optimization from practices just like yours."
      ...
      <div className="ar-faq-grid">
        <div className="ar-faq-item">
          <ServiceFAQ
            description="Everything you need to know about our accounts receivable management services."
            faqs={arFAQs}
      ...
      {/* ========== BOTTOM CTA ========== */}
      <div className="ar-bottom-cta">
        <ServiceBottomCTA
          title={arPageMeta.ctaTitle}
          description={arPageMeta.ctaDescription}
          primaryButtonText="Get Free A/R Audit"
        />
      </div>
    </div>
  );
