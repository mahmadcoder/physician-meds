  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-red-50/30 via-white to-orange-50/20">
        ...
        <div className="container-custom relative z-10 pt-24 sm:pt-28 md:pt-36 lg:pt-40 pb-10 sm:pb-14 md:pb-20">
          <div className="mb-5 sm:mb-6">
            <Link to="/services" onClick={() => window.scrollTo(0, 0)} className="dm-nav inline-flex items-center gap-2 text-gray-500 hover:text-brand-blue transition-colors group text-sm">
      ...
      <section className="py-10 sm:py-14 md:py-20 bg-white">
        <div className="container-custom">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12">
            <span className="inline-block text-xs sm:text-sm font-semibold text-brand-blue uppercase tracking-wider mb-2 sm:mb-3">Client Success</span>
            <h2 className="font-display text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-brand-dark mb-3 sm:mb-4">{dmPageMeta.testimonialsTitle}</h2>
            <p className="text-gray-600 text-xs sm:text-sm md:text-base">{dmPageMeta.testimonialsDescription}</p>
          </div>

          <div className="dm-testimonials-grid grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {dmTestimonials.map((testimonial) => {
              const initials = testimonial.name.split(" ").map(n => n[0]).join("").slice(0, 2);
              return (
                <div key={testimonial.name} className="dm-testimonial group bg-white rounded-2xl sm:rounded-3xl border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden">
                  ...
                  <div className="p-5 sm:p-6 md:p-7">
                    ...
                    <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                      <div className="relative flex-shrink-0">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-brand-blue to-brand-accent flex items-center justify-center text-white font-bold text-sm">
                          {initials}
                        </div>
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-brand-blue truncate">{testimonial.specialty}</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-600 text-xs sm:text-sm md:text-base mb-5 sm:mb-6">Everything you need to know about our denial management services.</p>
              <Link to="/consult-now" onClick={() => window.scrollTo(0, 0)}>
            ...
            <div className="lg:col-span-3">
              <div className="dm-faq-grid space-y-3 sm:space-y-4">
                {dmFAQs.map((faq, index) => (
                  <div key={faq.question} className="dm-faq-item bg-white rounded-xl sm:rounded-2xl border border-gray-100 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
      ...
      <section className="pb-12 sm:pb-16 md:pb-24">
        <div className="container-custom">
          <div className="dm-bottom-cta bg-gradient-to-br from-brand-blue via-brand-blue to-brand-accent rounded-xl sm:rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="font-display text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold mb-3 sm:mb-4">{dmPageMeta.ctaTitle}</h2>
              <p className="text-white/90 max-w-2xl mx-auto mb-5 sm:mb-6 md:mb-8 text-xs sm:text-sm md:text-base">{dmPageMeta.ctaDescription}</p>
