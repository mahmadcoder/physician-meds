  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-white">
      ...
      <section className="py-10 sm:py-14 md:py-24 bg-gradient-to-b from-blue-50/30 to-white">
        <div className="container-custom">
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12">
            ...
            <p className="text-gray-600 text-xs sm:text-sm md:text-base">
              Real feedback from practices that transformed their coding process
              with PhysicianMeds.
            </p>
          </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <h2 className="font-display text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-brand-dark mb-3 sm:mb-4">
                {codingPageMeta.faqTitle}
              </h2>
              <p className="text-gray-600 text-xs sm:text-sm md:text-base mb-5 sm:mb-6">
                {codingPageMeta.faqDescription}
              </p>
              <Link to="/consult-now" onClick={() => window.scrollTo(0, 0)}>
            ...
            <div className="lg:col-span-3">
              <div className="mc-faq-grid space-y-3 sm:space-y-4">
                {codingFAQs.map((faq, index) => (
                  <div
                    key={faq.question}
                    className="mc-faq-item bg-white rounded-xl sm:rounded-2xl border border-gray-100 shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md"
                  >
                    <button
                      onClick={() =>
      ...
      <section className="pb-12 sm:pb-16 md:pb-24">
        <div className="container-custom">
          <div className="mc-bottom-cta bg-gradient-to-br from-brand-blue via-brand-blue to-brand-accent rounded-xl sm:rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 text-center text-white relative overflow-hidden">
