        ...
        >
          {displayServices.map((service, index) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div className={`w-16 h-16 ${cardColors[index]} rounded-2xl flex items-center justify-center mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3`}>
